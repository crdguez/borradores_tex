...
%\noaddpoints % to omit double points count
\begin{parts}
\part[1] Discutir la solución del mismo según el valor de $a$ 
...
\begin{parts}
\part[2] Razonar si $f(x,y)=5x+2y$ alcanza un valor máximo y uno mínimo con las restricciones anteriores. En caso afirmativo, calcular dichos valores y los puntos en los que se alcanzan.   
\begin{solution}\\
...
\end{solution}
\part[1] Igual que el apartado anterior pero para $f(x,y)=6x+3y$ 
\begin{solution}\\
