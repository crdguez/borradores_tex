...
\part (0.75 puntos) ¿Para qué valores de x es la función f continua?
\begin{solution} \includegraphics[scale=0.4]{./recan1.png} \\
$ 1 $\end{solution}
\part (1.5 puntos) Calcular el mínimo valor que toma la función $f$ para $x \in \left[1, 4\right]$
\begin{solution}$ $\end{solution}
\part (1 punto) Calcular el $\displaystyle\lim_{x \to \infty}f(x)$ 
\begin{solution}$ 1 $\end{solution}
